...
('Juan', 'Pérez', 12345678, '1234567890', 'juan.perez@example.com', 'Av. Siempre Viva 742', 'Buenos Aires', 'Argentina', '01112345678'),
('María', 'González', 87654321, '0987654321', 'maria.gonzalez@example.com', 'Calle Falsa 123', 'CABA', 'Argentina', '01187654321'),
('Carlos', 'Martínez', 11223344, '1231231234', 'carlos.martinez@example.com', 'Calle de la Paz 456', 'Tigre', 'Argentina', '01111223344'),
('Laura', 'López', 44332211, '9876543210', 'laura.lopez@example.com', 'Av. Libertador 789', 'Tigre', 'Argentina', '01144332211'),
('Ana', 'Fernández', 22334455, '3213214321', 'ana.fernandez@example.com', 'Calle Nueva 101', 'San Fernando', 'Argentina', '01122334455'),
('Pedro', 'Ramírez', 33445566, '6543219870', 'pedro.ramirez@example.com', 'Av. Belgrano 202', 'CABA', 'Argentina', '01133445566'),
('Lucía', 'Sánchez', 55667788, '7890123456', 'lucia.sanchez@example.com', 'Calle de la Independencia 303', 'San Isidro', 'Argentina', '01155667788'),
('Diego', 'Hernández', 99887766, '4321098765', 'diego.hernandez@example.com', 'Calle de los Héroes 404', 'Pilar', 'Argentina', '01199887766'),
('Gabriela', 'Torres', 66554433, '2345678901', 'gabriela.torres@example.com', 'Av. San Martín 505', 'San Fernando', 'Argentina', '01166554433'),
('Javier', 'Gutiérrez', 55443322, '5678901234', 'javier.gutierrez@example.com', 'Calle del Sol 606', 'Tigre', 'Argentina', '01155443322');
go
...
INSERT INTO Productos (Codigo, Nombre, IdMarca, IdProveedor, Stock, IdTipo) VALUES
(1001, 'Producto A', 1, 1, 50, 1),
(1002, 'Producto B', 2, 2, 30, 1),
(1003, 'Producto C', 1, 1, 20, 2),
(1004, 'Producto D', 3, 2, 10, 2),
(1005, 'Producto E', 1, 1, 40, 1),
(1006, 'Producto F', 2, 2, 25, 3),
(1007, 'Producto G', 3, 1, 15, 3),
(1008, 'Producto H', 1, 2, 35, 1),
(1009, 'Producto I', 2, 1, 45, 2),
(1010, 'Producto J', 3, 2, 5, 3);
